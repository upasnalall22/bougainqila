    ...
    return (
      <div className="min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center flex-col gap-4">
          ...
          <Link to="/shop" className="text-primary text-sm underline">
            Back to Shop
          </Link>
        </main>
        <Footer />
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-16 w-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div>
            ...
            {product.description && (
              <div className="mb-6">
                <h2 className="text-xs tracking-[0.2em] uppercase text-muted-foreground mb-2">Description</h2>
            ...
            {product.design_craft && (
              <div className="mb-6">
                <h2 className="text-xs tracking-[0.2em] uppercase text-muted-foreground mb-2">Materials Used</h2>
            ...
            {product.ships_within && (
              <p className="text-xs text-muted-foreground mb-6">Usually ships within {product.ships_within}.</p>
            )}
            ...
            {/* Stock Status */}
            {!product.in_stock && <p className="text-sm text-destructive font-medium mb-3">Sold Out</p>}
            ...
            <div className="border-b border-border">
              ...
              {shippingOpen && (
                <div className="pb-4 text-sm text-muted-foreground leading-relaxed">
                  <p>
                    We ship across India. Standard delivery takes 5-7 business days. Express shipping available at
                    checkout.
                  </p>
              ...
              {askOpen && (
                <div className="pb-4 text-sm text-muted-foreground">
                  <p>
                    ...
                    <a href="mailto:studio@bougainqila.com" className="text-primary underline">
                      studio@bougainqila.com
                    </a>{" "}
                    or WhatsApp us at{" "}
                    <a href="https://wa.me/919810374919" className="text-primary underline">
                      +91 98103 74919
                    </a>
                    .
                  </p>
