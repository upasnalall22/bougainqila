...
const RefundPolicy = () => (
  <div className="min-h-screen flex flex-col">
    <SEOHead title="Refund Policy | BougainQila" description="BougainQila refund and return policy for handcrafted clay home decor products." canonical="/refund-policy" />
    <Navbar />
    <main className="flex-1 max-w-3xl mx-auto px-6 py-20 w-full">
      ...
      <div className="prose prose-sm text-muted-foreground space-y-4">
        <p>
          At BougainQila, we take great pride in the quality of our handcrafted products. Since each piece is made to
          order, we have a limited refund policy.
        </p>
        ...
        <p>
          ...
          issue. We will arrange a replacement or full refund.
        </p>
        <h3 className="text-foreground font-medium text-base">Cancellations</h3>
        <p>
          Orders can be cancelled within 24 hours of placement. After this window, production may have already begun and
