...
const CookiePolicy = () => (
  <div className="min-h-screen flex flex-col">
    <SEOHead
      title="Cookie Policy | BougainQila"
      description="Learn about how BougainQila uses cookies on our website."
      ...
      <div className="space-y-8 text-sm text-foreground/80 leading-relaxed">
        <section>
          ...
          <p>
            ...
            preferences, understand how you use our site, and improve your overall experience.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 mt-2 space-y-1">
            ...
            <li>
              <strong>Preference Cookies:</strong> Remember your settings and choices, such as newsletter popup
              dismissal and cookie consent.
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            You can control and delete cookies through your browser settings. Note that disabling certain cookies may
            affect the functionality of our website. Most browsers allow you to:
          </p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
