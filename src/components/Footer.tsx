...
const Footer = () => {
  ...
  const otherSocials = (socialContent?.description || "https://facebook.com/|https://pinterest.com/|https://youtube.com/").split("|");
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/our-story" className="opacity-70 hover:opacity-100 transition-opacity">Our Story</Link></li>
              <li><Link to="/journal" className="opacity-70 hover:opacity-100 transition-opacity">Journal</Link></li>
              <li><Link to="/connect" className="opacity-70 hover:opacity-100 transition-opacity">Connect</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href={`mailto:${email}`} className="opacity-70 hover:opacity-100 transition-opacity inline-flex items-center gap-2">
                  <Mail className="w-4 h-4" />
                  {email}
                </a>
              </li>
              <li>
                <a href={`tel:${phone.replace(/\s/g, "")}`} className="opacity-70 hover:opacity-100 transition-opacity inline-flex items-center gap-2">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity" aria-label="Instagram">
                <Instagram className="w-5 h-5" />
              </a>
              {otherSocials[0] && (
                <a href={otherSocials[0]} target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity" aria-label="Facebook">
                  <Facebook className="w-5 h-5" />
                </a>
              )}
              {otherSocials[1] && (
                <a href={otherSocials[1]} target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity" aria-label="Pinterest">
              ...
              {otherSocials[2] && (
                <a href={otherSocials[2]} target="_blank" rel="noopener noreferrer" className="opacity-70 hover:opacity-100 transition-opacity" aria-label="YouTube">
