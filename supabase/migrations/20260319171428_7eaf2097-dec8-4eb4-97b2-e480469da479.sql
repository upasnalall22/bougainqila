...
('hero', 'One of a Kind Clay Creations', 'Handcrafted with Love', 'Unique handmade home decor & accessories, crafted piece by piece with intention.', 'Explore More', '/shop', 'BougenQila — Handcrafted Clay Home Decor', 'BougenQila — Handcrafted clay home decor & accessories. Every piece is one of a kind.'),
